...
public interface RegistrableIPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.concurrent.CompletableFuture<Boolean> registerSeederAsync(String fileHash)
    {
        return _iceI_registerSeederAsync(fileHash, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Boolean> registerSeederAsync(String fileHash, java.util.Map<String, String> context)
    {
        return _iceI_registerSeederAsync(fileHash, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<Boolean> _iceI_registerSeederAsync(String iceP_fileHash, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default java.util.concurrent.CompletableFuture<Boolean> deregisterSeederAsync(String fileHash)
    {
        return _iceI_deregisterSeederAsync(fileHash, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Boolean> deregisterSeederAsync(String fileHash, java.util.Map<String, String> context)
    {
        return _iceI_deregisterSeederAsync(fileHash, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<Boolean> _iceI_deregisterSeederAsync(String iceP_fileHash, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default java.util.concurrent.CompletableFuture<Boolean> sendHashesAsync(String[] chunkHashes, String[] chunkIDs, String fileHash, String seederIP, int seederPort)
    {
    ...
    default java.util.concurrent.CompletableFuture<Boolean> sendHashesAsync(String[] chunkHashes, String[] chunkIDs, String fileHash, String seederIP, int seederPort, java.util.Map<String, String> context)
    {
        return _iceI_sendHashesAsync(chunkHashes, chunkIDs, fileHash, seederIP, seederPort, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<Boolean> _iceI_sendHashesAsync(String[] iceP_chunkHashes, String[] iceP_chunkIDs, String iceP_fileHash, String iceP_seederIP, int iceP_seederPort, java.util.Map<String, String> context, boolean sync)
    {
